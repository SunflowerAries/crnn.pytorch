...
parser.add_argument('--nepoch', type=int, default=45, help='number of epochs to train for')
...
parser.add_argument('--lr', type=float, default=0.000001, help='learning rate for Critic, not used by adadealta')
